                    ...
                    <div className={classes.bigContainer} key={'answer' + k + 1}>
                      <Paper className={classes.paper}>
                        <div className={classes.topInfo}>
                          <div>
                            <Typography variant="subtitle1" style={{ fontWeight: 'bold', paddingTop: 21,    margin-left: 10px; }} gutterBottom>
                              {k + 1 + '  '}.  {ReactHtmlParser(v.question)}
                            </Typography>
                            <Typography variant="body1" gutterBottom>
                              {
                                v.isCorrectAnswer ? (
                                  <i className={[classes.floatRight, "material-icons"].join(' ')}  >done</i>
                                ) : (
                                    < i className={[classes.floatRight, "material-icons"].join(' ')}>cancel</i>
                                  )}
                            </Typography>
                          </div>
                        </div>
