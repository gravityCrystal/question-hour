...
class Dashboard extends Component {
  ...
  verifyAnswerArray() {
    ...
    let x = {};
    let a = [] ;
    if(answeredQuestions.length > 10 || answeredQuestions.length < 10)


    answeredQuestions.forEach(function (newArrObj, index) {
      if (newArrObj.correctAnswer !== questions[index].correctAnswer) {
