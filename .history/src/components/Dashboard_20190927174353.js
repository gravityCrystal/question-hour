...
import { SnackbarProvider, wrapComponent } from 'react-snackbar-alert'; import CustomizedSnackbars from './common/statusMessage';
...
class Dashboard extends Component {
  ...
  verifyAnswerArray() {
    ...
    if (answeredQuestions.length !== 10) {
      return (<CustomizedSnackbars props={{
        openMessage: this.openMessage,
        open: true,
        openTextMessage: this.state.openTextMessage
