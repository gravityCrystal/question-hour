...
class Dashboard extends Component {
  ...
  verifyAnswerArray() {
    ...
    this.props.history.replace({ pathname: '/results', newProps: this.answeredQuestions, newProps: this.props })
  }
  callQuestionApi() {
          ...
          <Grid container justify="center">
            <Grid spacing={10} alignItems="center" justify="center" container className={classes.grid}>
              <Grid item xs={12}>
                ...
                {/* <Route exact path='/results' to={{ pathname: "/results" }} render={(props) => (<Results  {...props} />)}>
                  <Button color='primary' variant="contained" onClick={this.verifyAnswerArray} props={{
